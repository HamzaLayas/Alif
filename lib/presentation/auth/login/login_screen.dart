          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                BlocBuilder<LoginCubit, LoginState>(
                  builder: (context, state) {
                    return TextFormField(
                      ...
                      obscureText: loginCubit.isObscured,
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: Theme.of(context)
                            ...
                            .titleLarge!
                            .copyWith(color: AppColors.onSurfaceVariant),
                        prefixIcon: const Icon(AlifIcons.password, size: 30),
                        suffixIcon: InkWell(
                          onTap: () => loginCubit.obscureToggle(),
                          splashColor: AppColors.secondary,
                          borderRadius: BorderRadius.circular(50),
                          child: Icon(loginCubit.passwordIcon, size: 30),
                        ),
                      ),
                      onTapOutside: (event) => FocusScope.of(context).unfocus(),
                ...
                const Spacer(flex: 2),
                TextButton(
                  onPressed: () => Navigator.of(context).pushNamed("/retrieve"),
                  child: Text(
                    "نسيت كلمة المرور؟",
                    style: Theme.of(context)
                        .textTheme
                ...
                CustomElevatedButton(
                  text: 'تسجيل الدخول',
                  onTap: () => loginCubit.login(userCubit.updateCurrentUser),
                ),
                const Spacer(flex: 3),
                Row(
                  children: [
